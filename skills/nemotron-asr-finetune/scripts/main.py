...
ROUTES: tuple[Route, ...] = (
    ...
    Route(
        ...
        patterns=(
            ...
            r"\b(?:8|16)\s?khz\b",
            r"\bresample",
            r"\bdata(?:set)? quality\b",
            r"\btranscript quality\b",
            r"\bground truth\b",
            r"\blabel (?:noise|quality)\b",
            r"\bnemo version\b",
            r"\bwhich nemo\b",
            r"\bpull\b.*\bmain\b",
            r"\bnemo checkout\b",
            r"\bpackage version\b",
            r"\bdependenc(?:y|ies)\b",
            r"\benvironment check\b",
            r"\bsymlink\b|\bsymbolic link\b",
            r"\bnpx skills add\b",
            r"\bproject-local\b",
        ),
        next_steps=(
