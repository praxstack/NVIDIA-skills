## Description: <br>
Adapt BOP datasets, run the FoundationPose perception pipeline with TAO depth, and evaluate or re-score pose results. <br>
...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers who run depth, segmentation, and FoundationPose on BOP-format datasets using the TAO Deploy TensorRT depth engine, and who need to adapt datasets, preserve run provenance, and interpret pose metrics. <br>
...
- Efficiency: Checks tool-call productivity and token efficiency (equal-weight mean). <br>
